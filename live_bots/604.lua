...
local CONFIG = {
    ...
    -- تأییدشدهٔ زنده (1405/05/26): نسخهٔ Literal این رشته («§ion=2») روی سرور، هنگام ذخیرهٔ command،
    -- به «§ion=2» تبدیل شده بود (Teamyar به‌صورت Greedy رشتهٔ «§» را به Entity نامدار HTML «§»
    -- Decode کرده، دقیقاً همان خانوادهٔ Quirk ذخیره‌سازی که برای escape_html در CLAUDE.md مستند است، ولی
    -- این‌بار روی یک رشتهٔ کاملاً بی‌ربط به HTML). رفع شد با Concatenation تا رشتهٔ «§» پیوسته در
