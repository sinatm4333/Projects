  ...
  return "<div class='mv140-help-overlay' id='mv140HelpOverlay'>" +
    "<div class='mv140-help-modal'>" +
      "<div class='mv140-help-modal-header'>" +
        "<span>" + ty__main.botGetlang("HELP_TITLE") + "</span>" +
        "<button type='button' class='mv140-help-close' onclick='ty__main.close_help()'>×</button>" +
      "</div>" +
      "<div class='mv140-help-modal-body'>" + ty__main.botGetlang("HELP_BODY") + "</div>" +
    "</div>" +
  "</div>";
};
...
({
  ...
  [
    "<div class='mv140-header'>" +
      "<span class='mv140-title'>" + ty__main.botGetlang("PAGE_TITLE") + "</span>" +
      "<img class='mv140-brand-logo' src='data:image/png;base64," + ty__main.MV140_LOGO_B64 + "' alt='140' />" +
      "<button type='button' class='mv140-help-btn' onclick='ty__main.open_help()'>" + ty__main.botGetlang("HELP_BTN") + "</button>" +
    "</div>",
    "<div class='mv140-row'>" +
      $.Teamyar.input.text({
        id: "national_id",
      ...
      "<button type='button' id='show_row_btn' class='mv140-submit-btn' onclick='ty__main.get_status()'>" + ty__main.botGetlang("SUBMIT_BTN") + "</button>" +
    "</div>"
    , "<div id='err_msg'></div>"
    , "<div class='mv140-footer'>" + ty__main.botGetlang("FOOTER_TEXT") + "</div>"
