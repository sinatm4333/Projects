...
--[[
  ...
  - Filter: DELETED/CANCELED/REJECT=0 + TYPE NOT IN (1,5) — never PRE_INVOICE, never TYPE=4 only
...
if #matrix_rows_html == 0 then
    matrix_rows_html = { [[<tr><td colspan="17" class="empty-row">داده‌ای یافت نشد</td></tr>]] }
end
...
for i, entry in ipairs(replacements) do
    ...
    local receipt_url = "https://team.tsco.ir/?page=/pm/service_request/view/view_request/&id="
...
if #detail_rows_html == 0 then
    detail_rows_html = { [[<tr><td colspan="21" class="empty-row">در بازه انتخاب‌شده پذیرش تعویض‌شده‌ای یافت نشد</td></tr>]] }
end
        ...
        <div class="help-modal">
            ...
            <div class="help-modal-body">
                ...
                <ul>
                    ...
                    <li><b>گارانتی‌شده / گارانتی فعال</b> — تعداد سریال‌های تحت گارانتی این کالا / تعداد گارانتی‌های هنوز فعال</li>
                    <li><b>کل پذیرش‌شده</b> — تعداد کل پذیرش این کالا در تمام تاریخچه (بدون محدودیت بازهٔ انتخابی گزارش)</li>
                    <li><b>تعمیرشده در بازه</b> — تعداد پذیرش‌هایی که در بازهٔ انتخابی با «تعمیر» (نه تعویض) بسته شده‌اند</li>
