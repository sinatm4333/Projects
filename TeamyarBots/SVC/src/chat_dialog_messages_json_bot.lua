...
SELECT
    ...
    ]] .. fmt_jalali_datetime("msg_stats.first_message_raw") .. [[ AS first_message_date,
    ]] .. fmt_jalali_datetime("msg_stats.last_message_raw") .. [[ AS last_message_date,
    ]] .. fmt_jalali_datetime("participants.view_time") .. [[ AS last_view_time,
...
SELECT
    ...
    ]] .. fmt_jalali_datetime("cd.DATE_CREATE") .. [[ AS date_create,
    ]] .. fmt_jalali_datetime("cd.DATE_END") .. [[ AS date_end,
    ]] .. fmt_jalali_datetime("cd.LAST_MODIFIED") .. [[ AS last_modified,
...
SELECT
    ...
    ]] .. fmt_jalali_datetime("cm.DATE_CREATE") .. [[ AS date_create,
    ]] .. fmt_jalali_datetime("cm.LAST_MODIFIED") .. [[ AS last_modified,
