...
function getData(queryType , pageFrom , perPage , pageTo )
  ...
  if config ~= nil  then 
    local config_data = config.data
      teamyar.write_log("config----"..json.encode(config_data))
  ...
  dataQuery.query = string.gsub(dataQuery.query, "{{param_name1}}", param1);
  dataQuery.query = string.gsub(dataQuery.query, "{{param_name2}}", param2);
  dataQuery.query = string.gsub(dataQuery.query, "{{param_name3}}", param3);
  dataQuery.query = string.gsub(dataQuery.query, "{{param_name4}}", param4);
  dataQuery.query = string.gsub(dataQuery.query, "{{param_name5}}", param5);
  if work_day_name == nil  then 
    work_day_name = "--"
  end
    teamyar.write_log("---org-"..json.encode(org))
  dataQuery.query = string.gsub(dataQuery.query, "{{param_wh_name}}", work_day_name);
  if org ~= nil  then
