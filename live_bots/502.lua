...
if config ~= nil then
  ...
  c_author_id = config_data.author_id
...
function showLoginBtn()
  ...
  local srlang = "<script src='/bot/run/2/watsap_send_other_platform/"..lang..".js'></script>";
  res_data = [[
  <div id='myDiv'>
  ...
  <script src="/bot/run/2/watsap_send_other_platform/qrcode.js">
  </script>
  <link href='/bot/run/2/watsap_send_other_platform/main.css' rel='stylesheet' /> 
  <script src='/bot/run/2/watsap_send_other_platform/main.js'>
...
if #input_text>2 and   #number>0 then -- send message
  ...
  if err ~= nil and err ~= "" then -------show err in chat 
    ...
    local info2={message = err, author_id = c_author_id, dialog_id  = dialog_id}
