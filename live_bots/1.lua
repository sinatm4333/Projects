...
<h3 style="background-color:#00bf7d;text-align: center;border:1px dots black;height:40px;weight:100%%;padding-top:5px">تمامی زمان ها بر حسب روز و بصورت متوسط می باشد</h3>
<table>
  <thead>
...
input = [[ {"domain":"78.135.73.244","port":8001,"method":"GET","url":"/api/karbalad/salesbymonth","ssl":true,"secure":false}]]
...
local status = res["result"]["status"]
 ...
 --teamyar.write_result(context,body)
   ...
   for i=1 , #JD, 1 do
        table.insert(myArray, {JD[i]["shamsiSalesYear"],JD[i]["shamsiSalesMonth"],JD[i]["statusId"],JD[i]["count"]}) 
     end
