...
local CONFIG = {
    ...
    -- پیشگیرانه با Concatenation ساخته می‌شود (نه Literal «§ion=2») — روی بات خواهر
    -- (crm_geo_sales_dashboard_bot.lua) تأیید زندهٔ 1405/05/26: همین رشتهٔ Literal هنگام ذخیرهٔ command
    -- توسط Teamyar به «§ion=2» تبدیل شده بود (Decode حریصانهٔ «§» به Entity «§»، دقیقاً همان خانوادهٔ
