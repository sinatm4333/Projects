...
<h3 style="background-color:#00bf7d;text-align: center;border:1px dots black;height:40px;weight:100%%;padding-top:5px">فروش بر اساس وضعیت - تعداد</h3>
<table>
  <thead>
...
local status = res["result"]["status"]
 ...
 --teamyar.write_result(context,body)
   ...
   for i=1 , #JD, 1 do
        table.insert(myArray, {JD[i]["shamsiSalesYear"],JD[i]["shamsiSalesMonth"],JD[i]["salesStatus"],JD[i]["count"]}) 
     end
