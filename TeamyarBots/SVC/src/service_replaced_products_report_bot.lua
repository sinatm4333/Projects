...
if #matrix_rows_html == 0 then
    matrix_rows_html = { [[<tr><td colspan="15" class="empty-row">داده‌ای یافت نشد</td></tr>]] }
end
...
if #detail_rows_html == 0 then
    detail_rows_html = { [[<tr><td colspan="19" class="empty-row">در بازه انتخاب‌شده پذیرش تعویض‌شده‌ای یافت نشد</td></tr>]] }
end
        ...
        <div class="help-modal">
            ...
            <div class="help-modal-body">
                ...
                <ul>
                    ...
                    <li><b>میزان برگشتی / وضعیت</b> — نرخ برگشتی این کالا و برچسب وضعیت (قابل قبول / هشدار / بحرانی)</li>
                </ul>
