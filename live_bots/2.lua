...
input = [[ {"domain":"78.135.73.244","port":8001,"method":"GET","url":"/api/karbalad/salesbystatus","ssl":true,"secure":false}]]
...
local status = res["result"]["status"]
 ...
 --teamyar.write_result(context,body)
   ...
   for i=1 , #JD, 1 do
        table.insert(myArray, {JD[i]["shamsiSalesYear"],JD[i]["statusId"],JD[i]["count"]}) 
     end
